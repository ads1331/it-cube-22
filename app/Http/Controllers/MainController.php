...
'],
            ['text' => 'Узнайте, как усилить двухфакторную аутентификацию', 'author' => 'Используйте приложения для генерации одноразового кода! Это обеспечит приватность и доступность даже в случае отсутствия мобильного интернета. 
 
Примеры приложений: Яндекс Ключ, FreeOTP и другие.
'],
            ['text' => 'Уменьшайте публикацию личных данных в сети', 'author' => 'Создайте отдельный почтовый ящик для регистрации в различных сервисах!
...
'],
            ...
            ['text' => 'Минимизируйте риск компрометации своих аккаунтов', 'author' => 'При работе на чужих устройствах всегда выходите из аккаунтов, удаляйте историю из браузера и замените пароли от аккаунтов, в которые входили! 
...
'],
            ...
            ['text' => 'Вы уверены, что ваши данные доступны только вам?', 'author' => 'Проверьте свои аккаунты на предмет утечек в специальных сервисах: например, chk.safe-surf.ru или haveibeenpwned.com. 
...
'],
            ...
            ['text' => 'Не доверяйте запросам, в которых у вас просят деньги, банковские реквизиты или одноразовые коды! Даже от знакомых и близких!', 'author' => 'После взлома аккаунтов пользователей сети (почта, социальная сеть, мессенджеры), всем, с кем общались  владельцы взломанных аккаунтов, поступают массовые рассылки мошеннических сообщений (текстовые и голосовые) с запросом денег, банковских реквизитов или одноразовых кодов. 
...
'],
            ...
            ['text' => 'Соблюдайте правила этики в сети', 'author' => 'Запомните «золотое правило» общения в сети: не стоит писать человеку того, что вы бы ему не сказали лично. 
...
'],
            ...
            ['text' => 'Изучите признаки неблагонадежных сайтов', 'author' => 'Неблагонадежные сайты содержат следующие признаки:
...
'],
        ...
        return view('indexx', compact('quotes'));
    }
}
