...
<head>
    ...
    <title>Security Advent</title>
    <link rel="stylesheet" href="{{ asset('css/style.css') }}">
</head>
<body>
    <main>
        
        <div class="main__wrapp container">
            <div class="main__title">
                <h1><a href="{{route("subg")}}">Security Advent</a> <br> 2024</h1>
            </div>
        </div>
        <div class="main__start">
            <div class="space">
                <a href="#" data-id="1" class="open-modal"></a>
            </div>
            <div class="main__images">
                <div class="main__first">
                    <img src="{{ asset('images/robot2.gif') }}" alt="">
                </div>    
                <div class="button">
                    <a href="#" data-id="2" class="open-modal"></a>
                </div>
                <div class="main__secong">
        ...
        <div class="modal-content">
            ...
            <div class="main__iamges-2">
                <div class="svg-frame">
                    ...
                    <svg style="--i:2;--j:4;">
                        <path fill="#0f0f0f" d="M180.956 186.056C183.849 184.212 186.103 181.521 187.41 178.349C188.717 175.177 189.013 171.679 188.258 168.332C187.503 164.986 185.734 161.954 183.192 159.65C180.649 157.346 177.458 155.883 174.054 155.46C170.649 155.038 167.197 155.676 164.169 157.288C161.14 158.9 158.683 161.407 157.133 164.468C155.582 167.528 155.014 170.992 155.505 174.388C155.997 177.783 157.524 180.944 159.879 183.439L161.129 182.259C159.018 180.021 157.648 177.186 157.207 174.141C156.766 171.096 157.276 167.989 158.667 165.245C160.057 162.5 162.261 160.252 164.977 158.806C167.693 157.36 170.788 156.788 173.842 157.167C176.895 157.546 179.757 158.858 182.037 160.924C184.317 162.99 185.904 165.709 186.581 168.711C187.258 171.712 186.992 174.849 185.82 177.694C184.648 180.539 182.627 182.952 180.032 184.606L180.956 186.056Z" id="center1"></path>
                        <path fill="#0f0f0f" d="M172 166.445C175.068 166.445 177.556 168.932 177.556 172C177.556 175.068 175.068 177.556 172 177.556C168.932 177.556 166.444 175.068 166.444 172C166.444 168.932 168.932 166.445 172 166.445ZM172 177.021C174.773 177.021 177.021 174.773 177.021 172C177.021 169.227 174.773 166.979 172 166.979C169.227 166.979 166.979 169.227 166.979 172C166.979 174.773 169.227 177.021 172 177.021Z" id="center"></path>
                    </svg>
                
                </div>
                <div class="modal_btn position">
                    <a href="#" data-id="3" class="open-modal"></a>
                </div>
            </div>
            <div class="main__images-3">
                <div class="modal_btn position-1">
                    <a href="#" data-id="5" class="open-modal"></a>
                </div>
                <div class="modal_btn position-2">
                    <a href="#" data-id="4" class="open-modal"></a>
                </div>
            </div>
        </div>
        <div class="main__second">
            <div class="main__images-4"></div>
            <div class="main__images-5">
                <a href="#" data-id="6" class="open-modal"></a>
            </div>
            <div class="main__images-6">
                <a href="#" data-id="7" class="open-modal"></a>
            </div>
            <div class="main__images-7">
                <a class="hz open-modal" href="#" data-id="8" ></a>
            </div>
            <div class="main__images-8">
                <a href="#" data-id="9" class="open-modal position-8" ></a>
                <a href="#" data-id="10" class="open-modal position-8" ></a>
            </div>
            <div class="main__images-9">
                <a href="#" data-id="11" class="open-modal"></a>
            </div>
        </div> 
        <div class="main__third">
            <div class="maim__images-10">
                
            </div>
            <div class="main__images-11">

            </div>
            <div class="main__images-12">
                <a href="" data-id="12" class="open-modal"></a>
            </div>
            <div class="main__images-13">
                <a href="" data-id="13" class="open-modal position-13"></a>
            </div>
            <div class="main__images-14">
                <a href="" data-id="14" class="open-modal position-14"></a>
                <a href="" data-id="15"class="open-modal position-14"></a>
            </div>
            <div class="main__images-15">
                <a href="" data-id="16" class="open-modal position-15"></a>
                <a href="" data-id="17" class="open-modal position-15"></a>
            </div>
            <div class="main__images-16">
                <a href="" data-id="18" class="open-modal"></a>
            </div>
        </div>
        <div class="main__four">
            <div class="main__images-17">
                <a href="" data-id="19" class="open-modal"></a>
            </div>
            <div class="main__images-18">
                <a href="" data-id="20" class="open-modal"></a>
            </div>
            <div class="main__images-19">
                <a href="" data-id="21" class="open-modal"></a>
                <a href="" data-id="22" class="open-modal"></a>
            </div>
            <div class="main__images-20">
                <a href="" data-id="23" class="open-modal"></a>
                <a href="" data-id="24" class="open-modal"></a>
            </div>
            <div class="main__images-21">
                <a href="" data-id="25" class="open-modal"></a>
                <a href="" data-id="26" class="open-modal"></a>
                <a href="" data-id="27" class="open-modal"></a>
            </div>
            <div class="main__images-22">
                <a href="" data-id="28" class="open-modal"></a>
            </div>
            <div class="main__images-23">
                <a href="" data-id="29" class="open-modal"></a>
            </div>
            <div class="main__images-24">
                <a href="" data-id="30" class="open-modal"></a>
            </div>
        </div>
        <div class="main__five">
            <div class="main__images-25">
                <a href="" data-id="31" class="open-modal"></a>
            </div>
        </div>
        <div id="modal3" class="modal">
        <div class="modal-content">
            <span class="close" data-target="modal3">&times;</span>
            <p id="modal-content-3">Loading...</p>
        </div>
    </div>
    <div id="modal4" class="modal">
        <div class="modal-content">
            <span class="close" data-target="modal4">&times;</span>
            <p id="modal-content-4">Loading...</p>
        </div>
    </div>
    <div id="modal5" class="modal">
        <div class="modal-content">
            <span class="close" data-target="modal5">&times;</span>
            <p id="modal-content-5">Loading...</p>
        </div>
    </div>
    <div id="modal6" class="modal">
        <div class="modal-content">
            <span class="close" data-target="modal6">&times;</span>
            <p id="modal-content-6">Loading...</p>
        </div>
    </div>
    <div id="modal7" class="modal">
        <div class="modal-content">
            <span class="close" data-target="modal7">&times;</span>
            <p id="modal-content-7">Loading...</p>
        </div>
    </div><div id="modal8" class="modal">
        <div class="modal-content">
            <span class="close" data-target="modal8">&times;</span>
            <p id="modal-content-8">Loading...</p>
        </div>
    </div><div id="modal9" class="modal">
        <div class="modal-content">
            <span class="close" data-target="modal9">&times;</span>
            <p id="modal-content-9">Loading...</p>
        </div>
    </div>
    <div id="modal10" class="modal">
        <div class="modal-content">
            <span class="close" data-target="modal10">&times;</span>
            <p id="modal-content-10">Loading...</p>
        </div>
    </div>
    <div id="modal11" class="modal">
        <div class="modal-content">
            <span class="close" data-target="modal11">&times;</span>
            <p id="modal-content-11">Loading...</p>
        </div>
    </div>
    <div id="modal10" class="modal">
        <div class="modal-content">
    ...
    <div id="modal12" class="modal">
        <div class="modal-content">
            <span class="close" data-target="modal12">&times;</span>
            <p id="modal-content-12">Loading...</p>
        </div>
    </div>
    <div id="modal13" class="modal">
        <div class="modal-content">
            <span class="close" data-target="modal13">&times;</span>
            <p id="modal-content-13">Loading...</p>
        </div>
    </div>
    <div id="modal14" class="modal">
        <div class="modal-content">
            <span class="close" data-target="modal14">&times;</span>
            <p id="modal-content-14">Loading...</p>
        </div>
    </div>
    <div id="modal15" class="modal">
        <div class="modal-content">
            <span class="close" data-target="modal15">&times;</span>
            <p id="modal-content-15">Loading...</p>
        </div>
    </div>
    <div id="modal16" class="modal">
        <div class="modal-content">
            <span class="close" data-target="modal16">&times;</span>
            <p id="modal-content-16">Loading...</p>
        </div>
    </div>
    <div id="modal17" class="modal">
        <div class="modal-content">
            <span class="close" data-target="modal17">&times;</span>
            <p id="modal-content-17">Loading...</p>
        </div>
    </div>
    <div id="modal18" class="modal">
        <div class="modal-content">
            <span class="close" data-target="modal18">&times;</span>
            <p id="modal-content-18">Loading...</p>
        </div>
    </div>
    <div id="modal19" class="modal">
        <div class="modal-content">
            <span class="close" data-target="modal19">&times;</span>
            <p id="modal-content-19">Loading...</p>
        </div>
    </div>
    <div id="modal20" class="modal">
        <div class="modal-content">
            <span class="close" data-target="modal20">&times;</span>
            <p id="modal-content-20">Loading...</p>
        </div>
    </div>
    <div id="modal21" class="modal">
        <div class="modal-content">
            <span class="close" data-target="modal21">&times;</span>
            <p id="modal-content-21">Loading...</p>
        </div>
    </div>
    <div id="modal10" class="modal">
        <div class="modal-content">
    ...
    <div id="modal22" class="modal">
        <div class="modal-content">
            <span class="close" data-target="modal22">&times;</span>
            <p id="modal-content-22">Loading...</p>
        </div>
    </div>
    <div id="modal23" class="modal">
        <div class="modal-content">
            <span class="close" data-target="modal23">&times;</span>
            <p id="modal-content-23">Loading...</p>
        </div>
    </div>
    <div id="modal24" class="modal">
        <div class="modal-content">
            <span class="close" data-target="modal24">&times;</span>
            <p id="modal-content-24">Loading...</p>
        </div>
    </div>
    <div id="modal25" class="modal">
        <div class="modal-content">
            <span class="close" data-target="modal25">&times;</span>
            <p id="modal-content-25">Loading...</p>
        </div>
    </div>
    <div id="modal26" class="modal">
        <div class="modal-content">
            <span class="close" data-target="modal26">&times;</span>
            <p id="modal-content-26">Loading...</p>
        </div>
    </div>
    <div id="modal27" class="modal">
        <div class="modal-content">
            <span class="close" data-target="modal27">&times;</span>
            <p id="modal-content-27">Loading...</p>
        </div>
    </div>
    <div id="modal28" class="modal">
        <div class="modal-content">
            <span class="close" data-target="modal28">&times;</span>
            <p id="modal-content-28">Loading...</p>
        </div>
    </div>
    <div id="modal29" class="modal">
        <div class="modal-content">
            <span class="close" data-target="modal29">&times;</span>
            <p id="modal-content-29">Loading...</p>
        </div>
    </div>
    <div id="modal30" class="modal">
        <div class="modal-content">
            <span class="close" data-target="modal30">&times;</span>
            <p id="modal-content-30">Loading...</p>
        </div>
    </div>
    <div id="modal31" class="modal">
        <div class="modal-content">
            <span class="close" data-target="modal31">&times;</span>
            <p id="modal-content-31">Loading...</p>
        </div>
    </div>
...
// Функция для установки текста и состояния модального окна
function setModalContent(id) {
    const modal = document.getElementById(id);
    const index = id.replace('modal', '');
    const quote = quotes[index - 1]; // Поскольку индексы PHP начинаются с 1, а JS с 0
    const contentElement = document.getElementById(`modal-content-${index}`);
    const today = new Date();
    const currentDate = today.getDate();

    if (index > currentDate) {
        // Если модальное окно не доступно
        const daysLeft = index - currentDate;

        // Определяем дату и время, когда модальное окно станет доступным
        const availableDate = new Date(today.getFullYear(), today.getMonth(), index, 0, 0, 0); 
        ...
        contentElement.innerHTML = `Приходите через ${hoursLeft} час${hoursLeft !== 1 ? 'а' : ''} ${minutesLeft} минут${minutesLeft !== 1 ? 'ы' : ''}.`;
    } else {
        // Если модальное окно доступно
        contentElement.innerHTML = `<strong>${quote.text}</strong><br>— ${quote.author}`;
    }
}
...
function openModal(id) {
    const modal = document.getElementById(id);
    setModalContent(id); // Устанавливаем текст перед открытием
...
document.querySelectorAll('.open-modal').forEach(link => {
    link.addEventListener('click', (e) => {
        e.preventDefault();
        const modalId = `modal${e.target.getAttribute('data-id')}`;
        openModal(modalId);
    });
});

// Обработчик событий для закрытия модальных окон
document.querySelectorAll('.close').forEach(closeButton => {
    closeButton.addEventListener('click', () => {
        closeModal(closeButton.getAttribute('data-target'));
    });
});
